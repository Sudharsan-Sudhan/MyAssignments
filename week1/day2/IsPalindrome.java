...
public class IsPalindrome {
	...
	public static void main(String[] args) {
		...
		int num , inputNum;
		inputNum = num = a; // Change the value of inputNum & num as "a to h" to run this program with different inputs  
		int output = 0;
		int temp = 0;
		...
		if (inputNum==output) {
		    	System.out.println("Given Number is " + output +" a Palindrome");
		    }else if (inputNum!=output) {
		    	System.out.println("Given Number is " + output +" Not a Palindrome");
		    }
